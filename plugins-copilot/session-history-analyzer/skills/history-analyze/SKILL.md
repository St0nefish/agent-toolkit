...
description: >-
  ...
  coverage and routes to /session-history-analyzer:history-analyze for full analysis.
allowed-tools: SQL
---
...
3. Route to `/session-history-analyzer:history-analyze` for a full analysis run. Do not attempt to synthesize the full workflow report from this skill alone.
