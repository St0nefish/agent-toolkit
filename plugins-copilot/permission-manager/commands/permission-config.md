...
$IF(!$1, Available actions: `commands`, `allow-edit`, `web`, `explain`, `learn`. Usage: `/permission-manager:permission-config [action]`. To install dependencies, use `/permission-manager:setup`.)
